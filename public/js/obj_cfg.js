...
{
    obj_type_map = {
        Sedan:            {color: '#86af49',  size:[4.5, 1.8, 1.5], attr:["door open", "trunk open"]},
        TmpObj:        {color: '#008888',  size:[4.5, 1.8, 1.5]},
        BusorTruck:          {color: '#00ffff',  size:[10., 2.8, 3]},
        ...
        PedestrianGroups:     {color: '#ff0000',  size:[1.6, 0.6, 1.2]},
    ...
    popularCategories = ["Sedan", "BusorTruck"];
    ...
    get_obj_cfg_by_type(name){
        if (this.obj_type_map[name]){
            ...
            return this.obj_type_map["TmpObj"];
        }
    }
