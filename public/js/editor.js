...
function Editor(editorUi, wrapperUi, editorCfg, data, name="editor"){
    ...
    this.moveRangeCircle = function(world){
        if (this.rangeCircle.parent){
            ...
            world.webglGroup.add(this.auxLine1);
            world.webglGroup.add(this.auxLine2);
        }
    };
    ...
    this.addRangeCircle= function(){
        ...
        // TODO: add a two line ray from shooting from the origin to distance 120 meters away from -55 degrees to 55 degrees'
    ...
    this.showRangeCircle = function(show){
        ...
        if (show){
            if (this.data.world)
            {
                ...
                this.data.world.webglGroup.add(this.auxLine1);
                this.data.world.webglGroup.add(this.auxLine2);
            }
        }
        else 
        {
            if (this.rangeCircle.parent)
                ...
                this.auxLine1.parent.remove(this.auxLine1);
                this.auxLine2.parent.remove(this.auxLine2);
        }
    ...
    this.create_box_by_points=function(points, rotationZ){
       ...
       // var trans = transpose(euler_angle_to_rotate_matrix({x:0,y:0,z:rotation_z}, {x:0, y:0, z:0}), 4);
        ...
        return this.data.world.annotation.add_box(center, scale, localRot, "TmpObj", "");
    };
    ...
    this.selectBox = function(object){
        ...
        if (this.selected_box != object){
            ...
            if(pointsGlobalConfig.enableBoxOps){
